    ...
    <main className='flex w-full flex-col items-center justify-center'>
        ...
        <div className='grid w-full grid-cols-8 gap-16'>
            <div className='col-span-3 flex flex-col items-start justify-start'>
                <h2 className='mb-4 text-xl md:text-2xl font-bold uppercase text-black/75'>
                    Biography
                </h2>
                ...
                <p className='my-4 text-base md:text-lg font-medium text-dark'> 
            ...
            <div className='col-span-2 flex flex-col items-end justify-between'>
                <div className='flex flex-col items-end justify-center'>
                    <span className='inline-block text-6xl md:text-8xl font-bold text-dark'>
                        <AnimatedNumbers value={50} />+
                    </span>
                    <h2 className='text-xl md:text-2xl font-medium capitalize text-black/75'>
                        satisfied clients
                    </h2>
                </div>
